...
def home(request):
	...
	if request.method == "POST" :
		...
		api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode="+ zipcode +"&distance=5&API_KEY=B0E5FEF2-1961-49E2-9166-6E4D73B0DAFB")
		...
		if api[0]['Category']['Name'] == "Good":
			...
			category_color = "moderate"	
			  ...
			  category_color = "unheathy for sensitive groups"
		...
		api_request = requests.get("http://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=89129&distance=5&API_KEY=B0E5FEF2-1961-49E2-9166-6E4D73B0DAFB")
